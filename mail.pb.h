...
// required string msg = 1;
inline bool FuncType::has_msg() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void FuncType::set_has_msg() {
  _has_bits_[0] |= 0x00000001u;
}
inline void FuncType::clear_has_msg() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void FuncType::clear_msg() {
  if (msg_ != &::google::protobuf::internal::kEmptyString) {
    msg_->clear();
  }
  clear_has_msg();
}
inline const ::std::string& FuncType::msg() const {
  return *msg_;
}
inline void FuncType::set_msg(const ::std::string& value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void FuncType::set_msg(const char* value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void FuncType::set_msg(const char* value, size_t size) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline ::std::string* FuncType::mutable_msg() {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline ::std::string* FuncType::release_msg() {
  clear_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void FuncType::set_allocated_msg(::std::string* msg) {
  if (msg_ != &::google::protobuf::internal::kEmptyString) {
    delete msg_;
  }
  if (msg) {
